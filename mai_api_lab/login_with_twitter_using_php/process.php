...
var_dump($user_info);
//$jsonDecoded = json_decode($user_info,true);
//echo $jsonDecoded['email'];

//print_r($user->email);
//******************* send data to login or signup page *********************************
...
require_once('../DB.php');
    ...
    if($res_email){
       ...
       header('Location: ../home.php');
        ...
        $_SESSION['request_type'] = "twitter_request";
        $_SESSION['external_id']=$user_info->id;
        $_SESSION['request_email'] = $fname;
       header('Location: ../signup.php');
    }

//************* twitter api's database **********************************
